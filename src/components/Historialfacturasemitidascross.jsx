...
const Historialfacturasemitidascross = () => {
  ...
  useEffect(() => {
    const dbRef = ref(database, "historialcross");
  ...
  // Aquí se suma 1 día a la fecha de cada registro.
  ...
  const generatePDF = async () => {
    ...
    // Usamos homepageDataSorted (ya filtrado) para la tabla sin ordenar por numerodevoucher
    ...
    const firstInvoice =
      invoiceData.length > 0 ? invoiceData[0].invoice : invoiceNumber;

    // Preparar los datos para la tabla en el PDF
    const tableColumn = [
      "BILL TO",
      "HOTEL",
      "CUSTOMER REF",
    ...
    pdf.text(`INVOICE: ${firstInvoice}`, 140, marginTop + 10);
    ...
    pdf.save(`${firstInvoice || "Factura"}.pdf`);
  };
  ...
  return (
    <div className="homepage-container">
      ...
      <div className="homepage-card">
        <h1 className="title-page">Historial De Tours "Cross"</h1>
                  ...
                  <tr key={id}>
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          update(ref(database, `historialcross/${id}`), {
                    ...
                    <td>
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          await update(ref(database, `historialcross/${id}`), {
      ...
      {/* Componente FacturaInvoice en contenedor oculto */}
...
export default Historialfacturasemitidascross;
