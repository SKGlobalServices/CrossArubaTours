...
const Usuarios = () => {
  ...
  // Estado para controlar la visibilidad de la contraseña por fila (usando el id)
  ...
  // Función para alternar la visibilidad de la contraseña en cada fila
  const togglePasswordVisibilityForRow = (id) => {
    ...
    <div className="homepage-container">
      ...
      <div className="homepage-card">
        ...
        <div className="filters">
          <button className="create-table-button" onClick={addUser}>
            Agregar Usuario
          </button>
        </div>
                  ...
                  <tr key={id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => togglePasswordVisibilityForRow(id)}
                      >
